import pytest
import sheffield_parameter_set
...
def test_parameter_sets_entry_points():
    ...
    entry_points = list(sheffield_parameter_set.parameter_sets).sort()
    parameter_sets = Path("src/sheffield_parameter_set/parameters/input/").glob("*.py")
...
def test_parameter_sets_entry_point_load():
    ...
    parameters = sheffield_parameter_set.parameter_sets['Chen2020']
    # Loading parameter sets through the source file by dynamically loading Chen2020.py as a module
    spec = importlib.util.spec_from_file_location("Chen2020mod", "src/sheffield_parameter_set/parameters/input/Chen2020.py")
...
def test_model_entry_points():
    ...
    entry_points = list(sheffield_parameter_set.models).sort()
    models = Path("src/sheffield_parameter_set/models/input/").glob("*.py")
...
def test_model_entry_point_load():
    ...
    # Loading parameter_sets through entry points
    model_instance = sheffield_parameter_set.Model("SPM")
